...
public class IllIIlIIII1 extends ContextWrapper {
    ...
    public static final String f279lIIIIlllllIlll1 = IlIlllIIlI1.IllIIlIIII1.f239llllIIIIll1.llllIIIIll1(new byte[]{-73, 42, 85, -49, -17, 54, -122, 51, -100, 26, 73, -2, -31, 40, -126, 51, -106}, new byte[]{-28, 110, 30, -116, Byte.MIN_VALUE, 88, -14, 86});
    ...
    public IllIIlIIII1(Context context) {
        super(context);
        this.f280llllIIIIll1 = new llllIllIl1(context.getPackageManager());
    }
        ...
        try {
            for (StackTraceElement stackTraceElement : Thread.currentThread().getStackTrace()) {
                if (llllIIIIll1.lIIIIlllllIlll1(stackTraceElement)) {
                    String str = f279lIIIIlllllIlll1;
