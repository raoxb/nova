...
public class IlIllIlllIllI1 implements lllllIllIl1 {
    ...
    public IlIllIlllIllI1(String str, String str2, String str3, String str4, String str5, llllIIIIll1 lllliiiill1) {
        this.f401llllIIIIll1 = str;
        this.f402lIIIIlllllIlll1 = str2;
        this.f403llllIllIl1 = str3;
        this.f404IllIIlIIII1 = str4;
        this.f405IlIlllIIlI1 = str5 == null ? IlIlllIIlI1.IllIIlIIII1.f239llllIIIIll1.llllIIIIll1(new byte[]{50, -74}, new byte[]{70, -43, 86, 102, 94, -57, -45, 90}) : str5;
    ...
    public JSONObject toJSONObject() throws JSONException {
        ...
        jSONObject.put(lllliiiill1.llllIIIIll1(new byte[]{103, -24, -121, 14, -108}, new byte[]{19, -121, -20, 107, -6, 82, -49, 6}), this.f402lIIIIlllllIlll1);
        jSONObject.put(lllliiiill1.llllIIIIll1(new byte[]{-40, 25, -35, -8, 49, -67, 24}, new byte[]{-82, 124, -81, -117, 88, -46, 118, -50}), this.f401llllIIIIll1);
        jSONObject.put(lllliiiill1.llllIIIIll1(new byte[]{-17, -123, -31, -14, -85, -96}, new byte[]{-114, -11, -111, -83, -62, -60, 61, 24}), this.f403llllIllIl1);
        jSONObject.put(lllliiiill1.llllIIIIll1(new byte[]{-40, 48, -9, -115, 32, 2, -82, 98, -40}, new byte[]{-68, 85, -127, -28, 67, 103, -15, 11}), this.f404IllIIlIIII1);
        jSONObject.put(lllliiiill1.llllIIIIll1(new byte[]{21, 116, 2, -109, -102, 23, -107}, new byte[]{118, 28, 99, -3, -12, 114, -7, -77}), this.f405IlIlllIIlI1);
        jSONObject.put(lllliiiill1.llllIIIIll1(new byte[]{17, 110, -101, 63}, new byte[]{112, 26, -12, 82, 100, 42, 107, -43}), this.f406IlIllIlllIllI1.toJSONObject());
        return jSONObject;
    }
