...
public class IIlIllIIll1 implements lllllIllIl1 {
    ...
    public JSONObject toJSONObject() throws JSONException {
        ...
        jSONObject.put(lllliiiill1.llllIIIIll1(new byte[]{-89, -102, 59, 51}, new byte[]{-60, -11, 95, 86, 11, 54, 125, -9}), this.f388llllIIIIll1);
        jSONObject.put(lllliiiill1.llllIIIIll1(new byte[]{-108, -88, 62, -105, -106, 2, 85}, new byte[]{-7, -51, 77, -28, -9, 101, 48, 64}), this.f389lIIIIlllllIlll1);
        jSONObject.put(lllliiiill1.llllIIIIll1(new byte[]{116, -118, -83, -76}, new byte[]{0, -21, -34, -33, 119, 59, -8, -101}), this.f390llllIllIl1);
        return jSONObject;
    }
