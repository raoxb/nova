...
public class IlIlIIlIII1 implements lllllIllIl1 {
    ...
    public IlIlIIlIII1(String str, String str2, String str3, String str4, String str5, String str6, llllIIIIll1 lllliiiill1) {
        this.f394llllIIIIll1 = str;
        this.f395lIIIIlllllIlll1 = str2;
        this.f396llllIllIl1 = str3;
        this.f397IllIIlIIII1 = str4;
        this.f398IlIlllIIlI1 = str5;
        this.f399IlIllIlllIllI1 = str6 == null ? IlIlllIIlI1.IllIIlIIII1.f239llllIIIIll1.llllIIIIll1(new byte[]{40, -127}, new byte[]{92, -30, 117, -3, -9, 52, 89, -5}) : str6;
    ...
    public JSONObject toJSONObject() throws JSONException {
        ...
        jSONObject.put(lllliiiill1.llllIIIIll1(new byte[]{-60, 36, -105, -6, -118, 105, -81, -50}, new byte[]{-85, 66, -15, -97, -8, 54, -58, -86}), this.f394llllIIIIll1);
        jSONObject.put(lllliiiill1.llllIIIIll1(new byte[]{10, 13, 104, 102, -65, -1}, new byte[]{96, 98, 10, 57, -42, -101, 24, 113}), this.f395lIIIIlllllIlll1);
        jSONObject.put(lllliiiill1.llllIIIIll1(new byte[]{-72, -102, -76, -66, -84}, new byte[]{-52, -11, -33, -37, -62, 85, 100, 5}), this.f396llllIllIl1);
        jSONObject.put(lllliiiill1.llllIIIIll1(new byte[]{60, 16, -17, 3, 84, 63}, new byte[]{93, 96, -97, 92, 61, 91, 106, 58}), this.f397IllIIlIIII1);
        jSONObject.put(lllliiiill1.llllIIIIll1(new byte[]{106, 9, -36, -94, -61, -76, -109, -50, 106}, new byte[]{14, 108, -86, -53, -96, -47, -52, -89}), this.f398IlIlllIIlI1);
        jSONObject.put(lllliiiill1.llllIIIIll1(new byte[]{-27, -75, 71, -27, 73, 46, -35}, new byte[]{-122, -35, 38, -117, 39, 75, -79, 96}), this.f399IlIllIlllIllI1);
        jSONObject.put(lllliiiill1.llllIIIIll1(new byte[]{44, -104, 121, 92}, new byte[]{77, -20, 22, 49, -107, -95, 51, -80}), this.f400llllllIlIIIlll1.toJSONObject());
        return jSONObject;
    }
