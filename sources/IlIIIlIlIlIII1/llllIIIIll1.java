...
public class llllIIIIll1 {
    ...
    public static class C0001llllIIIIll1 extends FilterOutputStream {
        ...
        public void write(int i) throws IOException {
            ...
            if (!this.f117llllIIIIll1) {
                ...
                byte[] bArr = this.f119llllIllIl1;
                int i2 = this.f118lIIIIlllllIlll1;
                int i3 = i2 + 1;
                this.f118lIIIIlllllIlll1 = i3;
                bArr[i2] = (byte) i;
                if (i3 >= this.f120IllIIlIIII1) {
                    ((FilterOutputStream) this).out.write(this.f123llllllIlIIIlll1, 0, llllIIIIll1.lIIIIlllllIlll1(bArr, 0, this.f123llllllIlIIIlll1, 0, this.f125lIllIIIlIl1));
                    this.f118lIIIIlllllIlll1 = 0;
                    return;
                }
                return;
            }
            byte[] bArr2 = this.f119llllIllIl1;
            ...
            if (i5 >= i6) {
                ((FilterOutputStream) this).out.write(llllIIIIll1.llllIIIIll1(this.f123llllllIlIIIlll1, bArr2, i6, this.f125lIllIIIlIl1));
        ...
        public void IllIIlIIII1() throws IOException {
            ...
            if (i > 0) {
                ...
                ((FilterOutputStream) this).out.write(llllIIIIll1.llllIIIIll1(this.f123llllllIlIIIlll1, this.f119llllIllIl1, i, this.f125lIllIIIlIl1));
                this.f118lIIIIlllllIlll1 = 0;
            }
        }
        ...
        public C0001llllIIIIll1(OutputStream outputStream, int i) {
            ...
            this.f126IIlIllIIll1 = llllIIIIll1.llllIllIl1(i);
        }
    ...
    public static byte[] lIIIIlllllIlll1(byte[] bArr, int i, int i2, int i3) throws IOException {
        ...
        if (i2 >= 0) {
            ...
            while (i5 < i7) {
                boolean z2 = z;
                llllIIIIll1(bArr, i5 + i, 3, bArr2, i6, i3);
                i8 += 4;
                if (z2 && i8 >= 76) {
                    bArr2[i6 + 4] = 10;
                    i6++;
            ...
            if (i5 < i2) {
                llllIIIIll1(bArr, i5 + i, i2 - i5, bArr2, i6, i3);
                i6 += 4;
            }
            if (i6 > i4 - 1) {
                return bArr2;
        ...
        if (bArr2 != null) {
            if (i >= 0 && (i4 = i + 3) < bArr.length) {
                if (i2 >= 0 && (i5 = i2 + 2) < bArr2.length) {
                    ...
                    byte b = bArr[i + 2];
                    if (b == 61) {
                        bArr2[i2] = (byte) ((((llllIllIl12[bArr[i]] & 255) << 18) | ((llllIllIl12[bArr[i + 1]] & 255) << 12)) >>> 16);
                        return 1;
                    }
                    byte b2 = bArr[i4];
                    if (b2 == 61) {
                        int i6 = ((llllIllIl12[bArr[i]] & 255) << 18) | ((llllIllIl12[bArr[i + 1]] & 255) << 12) | ((llllIllIl12[b] & 255) << 6);
                        bArr2[i2] = (byte) (i6 >>> 16);
                        bArr2[i2 + 1] = (byte) (i6 >>> 8);
                        return 2;
                    }
                    int i7 = ((llllIllIl12[bArr[i]] & 255) << 18) | ((llllIllIl12[bArr[i + 1]] & 255) << 12) | ((llllIllIl12[b] & 255) << 6) | (llllIllIl12[b2] & 255);
                    bArr2[i2] = (byte) (i7 >> 16);
