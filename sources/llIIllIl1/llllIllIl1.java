...
public class llllIllIl1 implements lllllIllIl1, ByteChannel, llIlIIlll1.llllIIIIll1 {
    ...
    public synchronized int read(ByteBuffer byteBuffer) throws IOException {
        ...
        if (this.f742IlIlllIIlI1.hasRemaining()) {
            ...
            return IlIIIlIlIlIII1.lIIIIlllllIlll1.llllIIIIll1(this.f742IlIlllIIlI1, byteBuffer);
        }
                ...
                try {
                    ...
                    switch (llllIIIIll1.f745llllIIIIll1[unwrap.getStatus().ordinal()]) {
                        ...
                        case 2:
                            ...
                            return IlIIIlIlIlIII1.lIIIIlllllIlll1.llllIIIIll1(this.f742IlIlllIIlI1, byteBuffer);
                        case 3:
                            this.f742IlIlllIIlI1 = llllIIIIll1(this.f742IlIlllIIlI1, this.f739lIIIIlllllIlll1.getSession().getApplicationBufferSize());
        ...
        IlIIIlIlIlIII1.lIIIIlllllIlll1.llllIIIIll1(this.f742IlIlllIIlI1, byteBuffer);
        return read;
    }
    ...
    public synchronized int write(ByteBuffer byteBuffer) throws IOException {
        ...
        while (byteBuffer.hasRemaining()) {
            ...
            switch (llllIIIIll1.f745llllIIIIll1[wrap.getStatus().ordinal()]) {
                ...
                case 3:
                    this.f741IllIIlIIII1 = llllIIIIll1(this.f741IllIIlIIII1, this.f739lIIIIlllllIlll1.getSession().getPacketBufferSize());
                    break;
                case lIIIIlllllIlll1.llllIIIIll1.f334IllIIlIIII1 /* 4 */:
                    IlIllIlllIllI1();
                    return 0;
                        ...
                        try {
                            ...
                            switch (llllIIIIll1.f745llllIIIIll1[unwrap.getStatus().ordinal()]) {
                                case 1:
                                    break;
                                case 2:
                                    this.f743IlIllIlllIllI1 = IllIIlIIII1(this.f743IlIllIlllIllI1);
                                    break;
                                case 3:
                                    this.f742IlIlllIIlI1 = llllIIIIll1(this.f742IlIlllIIlI1, this.f739lIIIIlllllIlll1.getSession().getApplicationBufferSize());
                                    break;
    ...
    public final ByteBuffer llllIllIl1(ByteBuffer byteBuffer) {
        return llllIIIIll1(byteBuffer, this.f739lIIIIlllllIlll1.getSession().getPacketBufferSize());
    }

    public final ByteBuffer lIIIIlllllIlll1(ByteBuffer byteBuffer) {
        return llllIIIIll1(byteBuffer, this.f739lIIIIlllllIlll1.getSession().getApplicationBufferSize());
    }
    ...
    public final ByteBuffer IllIIlIIII1(ByteBuffer byteBuffer) {
        ...
        ByteBuffer llllIIIIll12 = llllIIIIll1(byteBuffer, this.f739lIIIIlllllIlll1.getSession().getPacketBufferSize());
        byteBuffer.flip();
