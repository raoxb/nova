...
public class IllIIlIIII1 implements ByteChannel, lllllIllIl1, llIlIIlll1.llllIIIIll1 {
    ...
    public IllIIlIIII1(SocketChannel socketChannel, SSLEngine sSLEngine, ExecutorService executorService, SelectionKey selectionKey) throws IOException {
        ...
        this.f692IlIllIlllIllI1.write(llllIllIl1(f684IlIIlllllI1));
    ...
    public int write(ByteBuffer byteBuffer) throws IOException {
        ...
        int write = this.f692IlIllIlllIllI1.write(llllIllIl1(byteBuffer));
    ...
    public int read(ByteBuffer byteBuffer) throws IOException {
        ...
        while (byteBuffer.hasRemaining()) {
            ...
            if ((llllIllIl1() || this.f695lIllIIIlIl1.getStatus() == SSLEngineResult.Status.BUFFER_UNDERFLOW) && this.f692IlIllIlllIllI1.read(this.f691IlIlllIIlI1) == -1) {
                return -1;
            }
            this.f691IlIlllIIlI1.flip();
            llIIIIlIlllIII1();
            int llllIIIIll12 = llllIIIIll1(this.f689llllIllIl1, byteBuffer);
    ...
    public final synchronized void lIIIIlllllIlll1(boolean z) throws IOException {
        ...
        if (z && this.f694IlIlIIlIII1.getHandshakeStatus() == SSLEngineResult.HandshakeStatus.NEED_UNWRAP) {
            if (!llllIllIl1() || this.f695lIllIIIlIl1.getStatus() == SSLEngineResult.Status.BUFFER_UNDERFLOW) {
                this.f691IlIlllIIlI1.compact();
            ...
            if (this.f695lIllIIIlIl1.getHandshakeStatus() == SSLEngineResult.HandshakeStatus.FINISHED) {
                llllIIIIll1(this.f694IlIlIIlIII1.getSession());
                return;
            }
        }
        IlIllIlllIllI1();
    ...
    public final void IlIllll1() {
        ...
        byte[] bArr = new byte[this.f691IlIlllIIlI1.remaining()];
        this.f698lllllIllIl1 = bArr;
        this.f691IlIlllIIlI1.get(bArr);
    }
    ...
    public SelectableChannel llllIIIIll1(boolean z) throws IOException {
        return this.f692IlIllIlllIllI1.configureBlocking(z);
    }
    ...
    public final int lIIIIlllllIlll1(ByteBuffer byteBuffer) throws SSLException {
        if (this.f689llllIllIl1.hasRemaining()) {
            return llllIIIIll1(this.f689llllIllIl1, byteBuffer);
        }
        if (!this.f689llllIllIl1.hasRemaining()) {
            this.f689llllIllIl1.clear();
        }
