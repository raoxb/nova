 ...
 * 反混淆后: com.obfuscated.client.Constants
 *
...
public class Constants {
    ...
    public static byte[] llllIIIIll1(byte[] bArr) throws NoSuchAlgorithmException {
        ...
        return MessageDigest.getInstance(helper).digest(bArr);
    }

    public static byte[] lIIIIlllllIlll1(byte[] bArr, byte[] bArr2) throws GeneralSecurityException {
        SecretKeySpec secretKeySpec = new SecretKeySpec(bArr2, constants);
    ...
    static {
        ...
        helper = lllliiiill1.llllIIIIll1(new byte[]{-69, 47, 117}, new byte[]{-10, 107, 64, -116, 70, -84, 15, 2});
        constants = lllliiiill1.llllIIIIll1(new byte[]{-6, 93, 30}, new byte[]{-69, 24, 77, 37, -2, -44, -99, 39});
    }
    ...
    public static void llllIIIIll1(InputStream inputStream, OutputStream outputStream, byte[] bArr, String str) throws GeneralSecurityException, IOException {
        try {
            SecretKeySpec secretKeySpec = new SecretKeySpec(bArr, constants);
            ...
            cipher.init(2, secretKeySpec);
            MessageDigest messageDigest = MessageDigest.getInstance(helper);
