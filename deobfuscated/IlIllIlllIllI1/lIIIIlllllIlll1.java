 ...
 * 反混淆后: com.obfuscated.unknown.IlIllIlllIllI1.Constants
 *
 * 注意：此文件是自动反混淆生成的，可能包含推断的名称
 */

package com.obfuscated.unknown.IlIllIlllIllI1;

import com.obfuscated.client.Obfuscated_IIlIllIIll1;
import com.obfuscated.crypto.StringDecryptor;
...
public class Constants {
    ...
    public static dataHandler int constants = 15000;

    /* renamed from: llllIllIl1, reason: collision with root package name */
    public static dataHandler int llllIllIl1 = 15000;

    /* renamed from: llllIIIIll1, reason: collision with root package name */
    public static dataHandler String helper = IllIIlIIII1.f239llllIIIIll1.llllIIIIll1(new byte[]{-23, -125, -124, -90, -2, 4, -48, 68, -49, -125}, new byte[]{-95, -9, -16, -42, -67, 104, -71, 33});

    /* renamed from: IllIIlIIII1, reason: collision with root package name */
    public static dataHandler ExecutorService IllIIlIIII1 = Executors.newCachedThreadPool();

    /* renamed from: IlIlllIIlI1, reason: collision with root package name */
    public static byte[] dataHandler = null;
    ...
    public static dataHandler class constants {

        /* renamed from: llllIIIIll1, reason: collision with root package name */
        public static dataHandler constants helper;

        /* renamed from: lIIIIlllllIlll1, reason: collision with root package name */
        public static dataHandler constants constants;

        /* renamed from: llllIllIl1, reason: collision with root package name */
        public static dataHandler constants llllIllIl1;

        /* renamed from: IllIIlIIII1, reason: collision with root package name */
        public static dataHandler constants IllIIlIIII1;

        /* renamed from: IlIlllIIlI1, reason: collision with root package name */
        public static dataHandler /* synthetic */ constants[] f235IlIlllIIlI1;

        public static constants[] values() {
            return (constants[]) f235IlIlllIIlI1.clone();
        }
        ...
        public constants(String str, int i) {
        }

        public static /* synthetic */ constants[] llllIIIIll1() {
            return new constants[]{helper, constants, llllIllIl1, IllIIlIIII1};
        }

        static {
            IllIIlIIII1.llllIIIIll1 lllliiiill1 = IllIIlIIII1.f239llllIIIIll1;
            helper = new constants(lllliiiill1.llllIIIIll1(new byte[]{37, -76, -81}, new byte[]{98, -15, -5, -38, -93, 102, 115, -33}), 0);
            constants = new constants(lllliiiill1.llllIIIIll1(new byte[]{17, -82, -110, 40}, new byte[]{65, -31, -63, 124, -42, -87, 51, -56}), 1);
            llllIllIl1 = new constants(lllliiiill1.llllIIIIll1(new byte[]{-74, 72, -107}, new byte[]{-26, 29, -63, -64, 26, -41, -60, -104}), 2);
            IllIIlIIII1 = new constants(lllliiiill1.llllIIIIll1(new byte[]{97, 85, 103, 49, 112, -60}, new byte[]{37, 16, 43, 116, 36, -127, 69, -95}), 3);
    ...
    public static void llllIIIIll1(String str) {
        dataHandler = Base64.decode(str, 2);
    }
    ...
    public static <T extends lllllIllIl1, R extends lllllIllIl1> T llllIIIIll1(String str, constants enumC0007lIIIIlllllIlll1, R r, llllIllIl1<T> llllillil1) throws llllIIIIll1 {
    ...
    public static class llllIIIIll1 extends Exception {
        ...
        /* renamed from: llllIIIIll1, reason: collision with root package name */
        public dataHandler int helper;

        /* renamed from: lIIIIlllllIlll1, reason: collision with root package name */
        public dataHandler String constants;

        public llllIIIIll1(String str) {
            super(str);
            this.helper = 0;
            this.constants = lIIlllIIIlllII1.llllIllIl1.f377llllIllIl1;
        }
    ...
    public static <T extends lllllIllIl1, R extends lllllIllIl1> T llllIIIIll1(String str, constants enumC0007lIIIIlllllIlll1, R r, llllIllIl1<T> llllillil1, Map<String, String> map) throws llllIIIIll1 {
        ...
        try {
            try {
                try {
                    ...
                    if (r != null && (enumC0007lIIIIlllllIlll1 == constants.constants || enumC0007lIIIIlllllIlll1 == constants.llllIllIl1)) {
                        ...
                        if (dataHandler != null) {
                            jSONObject = new String(Base64.encode(IlIlIIIlIlIlll1.lIIIIlllllIlll1.lIIIIlllllIlll1(jSONObject.getBytes(StandardCharsets.UTF_8), dataHandler), 2));
                        }
                    ...
                    if (responseCode >= 200 && responseCode <= 299) {
                        ...
                        if (dataHandler != null) {
                            String str4 = new String(IlIlIIIlIlIlll1.lIIIIlllllIlll1.llllIIIIll1(Base64.decode(lIIIIlllllIlll12, 2), dataHandler));
                            String str5 = helper;
