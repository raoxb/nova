 ...
 * 原始包名: lIllIIIlIl1
 * 原始类名: lIllIIIlIl1
 * 反混淆后: com.obfuscated.util.Obfuscated_lIllIIIlIl1
 *
...
public class Obfuscated_lIllIIIlIl1 implements lllllIllIl1 {
    ...
    public final JSONArray llllIllIl1;

    public lIllIIIlIl1(int i, String str, JSONArray jSONArray) {
        this.helper = i;
        this.constants = str;
        this.llllIllIl1 = jSONArray;
    }
    ...
    public JSONObject toJSONObject() throws JSONException {
        ...
        jSONObject.put(lllliiiill1.llllIIIIll1(new byte[]{88, 52, 5, -122}, new byte[]{59, 91, 97, -29, -24, -108, -84, -126}), this.helper);
        jSONObject.put(lllliiiill1.llllIIIIll1(new byte[]{57, 119, -81, -103, -106, 101, -120}, new byte[]{84, 18, -36, -22, -9, 2, -19, -41}), this.constants);
        jSONObject.put(lllliiiill1.llllIIIIll1(new byte[]{35, 23, -120, 67, 99, -114, -75, -109}, new byte[]{83, 118, -21, 40, 2, -23, -48, -32}), this.llllIllIl1);
        return jSONObject;
    }
