 ...
 * 原始包名: lIllIIIlIl1
 * 原始类名: lllIlIIIlI1
 * 反混淆后: com.obfuscated.util.Obfuscated_lllIlIIIlI1
 *
...
public class Obfuscated_lllIlIIIlI1 implements lllllIllIl1 {
    ...
    public lllIlIIIlI1(String str, String str2, String str3, String str4, String str5, String str6, List<String> list, llllIIIIll1 lllliiiill1) {
        ...
        this.IllIIlIIII1 = str4 == null ? IlIlllIIlI1.IllIIlIIII1.f239llllIIIIll1.llllIIIIll1(new byte[]{-7, 36}, new byte[]{-115, 71, 99, -92, -1, -79, 123, Byte.MIN_VALUE}) : str4;
    ...
    public JSONObject toJSONObject() throws JSONException {
        ...
        jSONObject.put(lllliiiill1.llllIIIIll1(new byte[]{85, 62, -46, -121, -112}, new byte[]{33, 81, -71, -30, -2, 101, 109, 126}), this.helper);
        jSONObject.put(lllliiiill1.llllIIIIll1(new byte[]{-30, 44, -80, -123, -78, 31}, new byte[]{-125, 92, -64, -38, -37, 123, 66, -80}), this.constants);
        jSONObject.put(lllliiiill1.llllIIIIll1(new byte[]{86, -80, 40, -99, -65, -68, 37, 81, 86}, new byte[]{50, -43, 94, -12, -36, -39, 122, 56}), this.llllIllIl1);
        jSONObject.put(lllliiiill1.llllIIIIll1(new byte[]{-91, 104, 46, 16, -55, 98, 41}, new byte[]{-58, 0, 79, 126, -89, 7, 69, -105}), this.IllIIlIIII1);
        jSONObject.put(lllliiiill1.llllIIIIll1(new byte[]{22, -9, 107, -121, -33, -18, 65, -113}, new byte[]{121, -111, 13, -30, -83, -79, 40, -21}), this.dataHandler);
        jSONObject.put(lllliiiill1.llllIIIIll1(new byte[]{83, -10, -58, -14, -60, -4}, new byte[]{57, -103, -92, -83, -83, -104, 53, -29}), this.IlIllIlllIllI1);
        jSONObject.put(lllliiiill1.llllIIIIll1(new byte[]{27, -114, Byte.MAX_VALUE, -44}, new byte[]{119, -31, 24, -89, 2, -74, -127, 114}), new JSONArray((Collection) this.llllllIlIIIlll1));
        jSONObject.put(lllliiiill1.llllIIIIll1(new byte[]{12, 74, 14, -57}, new byte[]{109, 62, 97, -86, 123, -14, -63, 55}), this.IlIlIIlIII1.toJSONObject());
        return jSONObject;
    }
