 ...
 * 原始包名: IIIlIllIlI1
 * 原始类名: IllIIlIIII1
 * 反混淆后: com.obfuscated.webview.StringDecryptor
 *
...
public class StringDecryptor {
    ...
    public static final String dataHandler = IlIlllIIlI1.IllIIlIIII1.f239llllIIIIll1.llllIIIIll1(new byte[]{119, 91, -94, 101, 0, -43, 85, -61, 72, 65, -96, 125, 20, -51, 113, -26, 79, 86, -68, 116, 7}, new byte[]{33, 50, -48, 17, 117, -76, 57, -121});

    /* renamed from: IlIllIlllIllI1, reason: collision with root package name */
    public static HandlerThread IlIllIlllIllI1;

    /* renamed from: llllllIlIIIlll1, reason: collision with root package name */
    public static Handler llllllIlIIIlll1;

    /* renamed from: llllIIIIll1, reason: collision with root package name */
    public final VirtualDisplay helper;

    /* renamed from: lIIIIlllllIlll1, reason: collision with root package name */
    public lIIIIlllllIlll1 constants;

    /* renamed from: llllIllIl1, reason: collision with root package name */
    public ImageReader llllIllIl1;

    /* renamed from: IllIIlIIII1, reason: collision with root package name */
    public Bitmap IllIIlIIII1;
    ...
    public static class lIIIIlllllIlll1 extends Presentation {
        ...
        public void onCreate(Bundle bundle) {
            ...
            WebView webView = this.helper;
            if (webView != null) {
                webView.setFocusable(false);
                this.helper.setFocusableInTouchMode(false);
                setContentView(this.helper);
            }
        }
    }
    ...
    public class llllIIIIll1 implements ImageReader.OnImageAvailableListener {
        ...
        public void helper(ImageReader imageReader) {
            try {
                ...
                if (acquireLatestImage != null) {
                    ...
                    synchronized (IllIIlIIII1.class) {
                        ...
                        illIIlIIII1.llllIIIIll1(illIIlIIII1.IllIIlIIII1);
                    }
                    IllIIlIIII1.this.IllIIlIIII1 = lIIIIlllllIlll12;
                }
            } catch (Throwable th) {
    ...
    public IllIIlIIII1(Context context, float f, IlIlllIIlI1 ilIlllIIlI1) {
        ...
        if (ilIlllIIlI1 != null) {
            if (IlIllIlllIllI1 == null) {
                ...
                IlIllIlllIllI1 = handlerThread;
                handlerThread.start();
                llllllIlIIIlll1 = new Handler(IlIllIlllIllI1.getLooper());
            }
            this.llllIllIl1.setOnImageAvailableListener(new llllIIIIll1(ilIlllIIlI1), llllllIlIIIlll1);
        }
        this.helper = displayManager.createVirtualDisplay(lllliiiill1.llllIIIIll1(new byte[]{96, -74, -99, -70}, new byte[]{23, -64, -21, -34, -38, -23, -39, 64}), i, i2, i3, surface, 2);
    }

    public void lIIIIlllllIlll1() {
        lIIIIlllllIlll1 liiiilllllilll1 = this.constants;
        if (liiiilllllilll1 != null) {
            try {
                liiiilllllilll1.dismiss();
            } catch (Throwable th) {
                lllllIllIl1.IllIIlIIII1.lIIIIlllllIlll1(Log.LogLevel.WARN, dataHandler, IlIlllIIlI1.IllIIlIIII1.f239llllIIIIll1.llllIIIIll1(new byte[]{75, -89, Byte.MIN_VALUE, 70, -119, -18, -109, -23, 79, -68, -118, 91, -52, -28, -114, -5, 86, -68, -106, 70, -52, -26, -122, -31, 87, -80, -127, 21, -101, -23, -109, -32, 27, -80, -99, 86, -119, -16, -109, -31, 84, -69}, new byte[]{59, -43, -27, 53, -20, Byte.MIN_VALUE, -25, -120}) + th);
            }
        }
        VirtualDisplay virtualDisplay = this.helper;
        if (virtualDisplay != null) {
            try {
                virtualDisplay.release();
            } catch (Throwable th2) {
                lllllIllIl1.IllIIlIIII1.lIIIIlllllIlll1(Log.LogLevel.WARN, dataHandler, IlIlllIIlI1.IllIIlIIII1.f239llllIIIIll1.llllIIIIll1(new byte[]{35, 11, -2, -118, -89, 123, 59, 117, 38, 10, -2, -98, -93, 126, 50, 113, 49, 79, -87, -111, -74, Byte.MAX_VALUE, 126, 113, 45, 12, -69, -120, -74, 126, 49, 122}, new byte[]{85, 111, -34, -8, -62, 23, 94, 20}) + th2);
            }
        }
        ImageReader imageReader = this.llllIllIl1;
        if (imageReader != null) {
            try {
                imageReader.close();
            } catch (Throwable th3) {
                lllllIllIl1.IllIIlIIII1.lIIIIlllllIlll1(Log.LogLevel.WARN, dataHandler, IlIlllIIlI1.IllIIlIIII1.f239llllIIIIll1.llllIIIIll1(new byte[]{8, 109, 29, 32, -14, 26, -108, 65, 5, 101, 14, 103, -12, 36, -98, 83, 4, 32, 26, 38, -2, 36, -108, 68, 65, 119, 21, 51, -1, 104, -108, 88, 2, 101, 12, 51, -2, 39, -97}, new byte[]{97, 0, 124, 71, -105, 72, -15, 32}) + th3);
            }
        }
        Bitmap bitmap = this.IllIIlIIII1;
        if (bitmap == null || bitmap.isRecycled()) {
            return;
        }
        llllIIIIll1(this.IllIIlIIII1);
    }
    ...
    public final void llllIIIIll1(Bitmap bitmap) {
        ...
        try {
            ...
            lllllIllIl1.IllIIlIIII1.lIIIIlllllIlll1(Log.LogLevel.WARN, dataHandler, IlIlllIIlI1.IllIIlIIII1.f239llllIIIIll1.llllIIIIll1(new byte[]{75, 9, 75, -68, 124, 10, -8, -123, 91, 5, 92, -88, 126, 22, -67, -61, 88, 5, 68, -96, 123}, new byte[]{57, 108, 40, -59, 31, 102, -99, -91}) + th);
        }
    }
    ...
    */
    ...
    public void llllIIIIll1(Context context, WebView webView) {
        lIIIIlllllIlll1 liiiilllllilll1 = new lIIIIlllllIlll1(context, this.helper.getDisplay(), webView);
        this.constants = liiiilllllilll1;
