 ...
 * 原始包名: IlIlIIlIII1
 * 原始类名: llllIIIIll1
 * 反混淆后: com.obfuscated.unknown.IlIlIIlIII1.Helper
 *
...
import java.util.IllIIlIIII1;
import com.obfuscated.util.Obfuscated_lllllIllIl1;
...
public class Helper {
    ...
    public static class lIIIIlllllIlll1 {
        ...
        /* renamed from: IllIIlIIII1, reason: collision with root package name */
        public final IllIIlIIII1<String, List<String>> f219IllIIlIIII1;

        public lIIIIlllllIlll1(int i, String str, String str2, IllIIlIIII1<String, List<String>> map) {
            this.helper = i;
            this.constants = str;
        ...
        public IllIIlIIII1<String, List<String>> llllIllIl1() {
    ...
    public llllIIIIll1(String str) {
        this.helper = str;
        this.constants = 10000;
        this.llllIllIl1 = 30000;
    }

    static {
        IllIIlIIII1.llllIIIIll1 lllliiiill1 = IlIlllIIlI1.IllIIlIIII1.f239llllIIIIll1;
        IllIIlIIII1 = lllliiiill1.llllIIIIll1(new byte[]{51, -67, -83, -56, -100, -110, -108, -108, 21, -67}, new byte[]{123, -55, -39, -72, -33, -2, -3, -15});
        dataHandler = lllliiiill1.llllIIIIll1(new byte[]{118, 29, -43, Byte.MIN_VALUE, 33, 71, 86, 29, 126, 2, -53, -61, 34, 87, 88, 7, 44, 77, -58, -124, 41, 86, 68, 12, 99, 80, -48, -104, 46, 9, 15}, new byte[]{23, 109, -91, -20, 72, 36, 55, 105});
    }

    public <T extends lllllIllIl1> lIIIIlllllIlll1 llllIIIIll1(String str, T t, IllIIlIIII1<String, String> map) throws JSONException {
        String jSONObject = t.toJSONObject().toString();
        HashMap hashMap = new HashMap(map);
        hashMap.put(IlIlllIIlI1.IllIIlIIII1.f239llllIIIIll1.llllIIIIll1(new byte[]{71, -88, -101, -122, 17, 92, 76, -123, 80, -66, -123, -105}, new byte[]{4, -57, -11, -14, 116, 50, 56, -88}), dataHandler);
    ...
    public static class helper extends RuntimeException {
        ...
        public helper(String str, int i, String str2) {
            super(str, null);
            this.helper = i;
            this.constants = str2;
        }
        ...
        public helper(String str, int i, String str2, Throwable th) {
            super(str, th);
            this.helper = i;
            this.constants = str2;
        }
    ...
    public lIIIIlllllIlll1 llllIIIIll1(String str, IllIIlIIII1<String, String> map) {
    ...
    public lIIIIlllllIlll1 llllIIIIll1(String str, String str2, IllIIlIIII1<String, String> map) {
    ...
    public <T extends lllllIllIl1> lIIIIlllllIlll1 llllIIIIll1(String str, T t) throws JSONException {
        return llllIIIIll1(str, (String) t, (IllIIlIIII1<String, String>) new HashMap());
    }
    ...
    public <REQ extends lllllIllIl1, RESP extends lllllIllIl1> RESP llllIIIIll1(String str, REQ req, Class<RESP> cls) throws JSONException {
        return (RESP) llllIIIIll1(str, (String) req, (Class) cls, (IllIIlIIII1<String, String>) new HashMap());
    }

    public <REQ extends lllllIllIl1, RESP extends lllllIllIl1> RESP llllIIIIll1(String str, REQ req, Class<RESP> cls, IllIIlIIII1<String, String> map) throws JSONException {
        ...
        if (llllIIIIll12.IlIlllIIlI1()) {
            if (llllIIIIll12.llllIIIIll1() != null && !llllIIIIll12.llllIIIIll1().isEmpty()) {
                try {
                    ...
                    IllIIlIIII1.llllIIIIll1 lllliiiill1 = IlIlllIIlI1.IllIIlIIII1.f239llllIIIIll1;
                    Log.e(IllIIlIIII1, lllliiiill1.llllIIIIll1(new byte[]{-30, 100, -32, 36, 77, 11, -1, 74, -53, 37, -7, 41, 90, 28, -70, 30, -42, 96, -6, 56, 71, 1, -84, 91, -124, 79, -38, 7, 102}, new byte[]{-92, 5, -119, 72, 40, 111, -33, 62}), e);
                    throw new helper(llllIIIIll1.lIIIIlllllIlll1.llllIIIIll1(e, new StringBuilder().append(lllliiiill1.llllIIIIll1(new byte[]{67, 70, -100, 70, 33, -61, -89, -20, 106, 7, -123, 75, 54, -44, -30, -72, 119, 66, -122, 90, 43, -55, -12, -3, 63, 7}, new byte[]{5, 39, -11, 42, 68, -89, -121, -104}))), llllIIIIll12.lIIIIlllllIlll1(), llllIIIIll12.llllIIIIll1());
                }
            }
            throw new helper(IlIlllIIlI1.IllIIlIIII1.f239llllIIIIll1.llllIIIIll1(new byte[]{35, 74, 82, 24, -79, 14, 95, 83, 21, 87, 77, 2, -69, 75, 13, 84, 9, 67, 91}, new byte[]{102, 39, 34, 108, -56, 46, 45, 54}), llllIIIIll12.lIIIIlllllIlll1(), null);
        }
        throw new helper(IlIlllIIlI1.IllIIlIIII1.f239llllIIIIll1.llllIIIIll1(new byte[]{-45, -37, -126, 26, 10, -8, -126, 38, -18, -22, -91, 62, 10, -20, -122, 62, -9, -22, -78, 112, 10}, new byte[]{-101, -113, -42, 74, 42, -118, -25, 87}) + llllIIIIll12.lIIIIlllllIlll1() + " " + llllIIIIll12.IllIIlIIII1(), llllIIIIll12.lIIIIlllllIlll1(), llllIIIIll12.llllIIIIll1());
    }
    ...
    */
    public final IlIlIIlIII1.llllIIIIll1.lIIIIlllllIlll1 llllIIIIll1(java.lang.String r24, java.lang.String r25, java.lang.String r26, java.util.IllIIlIIII1<java.lang.String, java.lang.String> r27) {
        /*
            Method dump skipped, instructions count: 1681
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: IlIlIIlIII1.llllIIIIll1.llllIIIIll1(java.lang.String, java.lang.String, java.lang.String, java.util.IllIIlIIII1):IlIlIIlIII1.llllIIIIll1$lIIIIlllllIlll1");
    }
