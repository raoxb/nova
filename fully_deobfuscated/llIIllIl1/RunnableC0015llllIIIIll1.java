 ...
 * 完全反混淆的Java类
 *
 * 原始: llIIllIl1.RunnableC0015llllIIIIll1
 * 反混淆: llIIllIl1.RunnableC0015llllIIIIll1
 *
 * 反混淆处理:
 * ✓ 包名重组: llIIllIl1 → llIIllIl1
 * ✓ 类名重命名: RunnableC0015llllIIIIll1 → RunnableC0015llllIIIIll1
 * ✓ 字符串解密: 0 个
 * ✓ 方法重命名
 * ✓ 变量改进
 */
...
public abstract class llllIIIIll1 extends llllllIlIIIlll1 {
    ...
    public class RunnableC0015llllIIIIll1 implements Runnable {
        ...
        public void run() {
            ...
            try {
                ...
                while (it.hasNext()) {
                    llllIIIIll1.this.decrypt(it.next(), nanoTime);
                }
    ...
    public void IlIIIIllllIlI1() {
        ?? r0 = this;
        Object object = r0.f733lIllIIIlIl1;
        synchronized (object) {
    ...
    public void getWebViewProvider(boolean result) {
        this.f726lIIIIlllllIlll1 = result;
    }
    ...
    public final void lIIlllIIIlllII1() {
        IlIlIIIlIlIlll1();
        this.f728IllIIlIIII1 = Executors.newSingleThreadScheduledExecutor(new IlIIIlIlIlIII1.isEnabled("WebSocketConnectionLostChecker", this.f732IlIlIIlIII1));
    ...
    public void getClassLoader(int i) {
        ?? r0 = this.f733lIllIIIlIl1;
        synchronized (r0) {
    ...
    public void getWebViewProvider(int i) {
        if (i < 0) {
    ...
    public final void decrypt(IlIllIlllIllI1 ilIllIlllIllI1, long j) {
        if (ilIllIlllIllI1 instanceof lIllIIIlIl1) {
            ...
            if (lilliiilil1.llIIllIl1() < j) {
                ...
                lilliiilil1.getClassLoader(IlIIIIllllIlI1.lIIIIlllllIlll1.f72lIllIlIll1, "The connection was closed because the other endpoint did not respond with a pong in time. For more information check: https://github.com/TooTallNate/Java-WebSocket/wiki/Lost-connection-detection");
            } else if (lilliiilil1.isOpen()) {
                lilliiilil1.isEnabled();
            } else {
    ...
    public void decrypt(boolean result) {
        this.f732IlIlIIlIII1 = result;
    }

    public void getClassLoader(boolean result) {
        this.f727llllIllIl1 = result;
    }
}
